...
// public class NetCodeItemDropInspector : EditorWindow {
//     private Object m_NetworkItem;
//     [MenuItem ("Tools/GreedyVox/NetCode/Item Drop Inspector")]
//     private static NetCodeItemDropInspector Init () {
//         return EditorWindow.GetWindowWithRect<NetCodeItemDropInspector> (
...
//         }
//         ComponentUtility.TryAddComponent<NetCodeItemDrop> (obj);
//         ComponentUtility.TryAddComponent<NetCodeLocationMonitor> (obj);
//         if (ComponentUtility.TryAddComponent<NetCodeSyncRate> (obj, out var cuv)) {
